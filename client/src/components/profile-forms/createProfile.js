...
const createProfile = props => {
    ...
    const {
        user, portfolio, company, location, profession, skills, bio, experience, education, linkedin, github, twitter, instagram
    } = formData;
    ...
    return (
      ...
      <form className="form">
        <div className="form-group">
          ...
          <small className="form-text">Where are you right now in your career?</small>
        </div>
        <div className="form-group">
